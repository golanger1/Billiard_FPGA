...
logic [0:10][7:0] balls_colors = {8'hfe,8'h03,8'h1C,8'hC0,8'h00,8'h00,8'h00,8'h00,8'h00,8'h00,8'h00};
...
//assign hitBall_DR_VEC = InsideRectangle & balls_in_game & ;
	...
	/*		
			...
			if (InsideRectangle[3] && balls_in_game[3]) //   3 - RedBall
				begin
					if(object_colors[offsetY[3]][offsetX[3]] == GENERIC_COLOR_ENCODING || object_colors[offsetY[3]][offsetX[3]] == 8'h00)
						begin
							not_Transparent = 1'b1;
							hitBall_DR_VEC[3] = 1'b1;
							HitEdgeCode[3] <= hit_colors[offsetY[3] >> 3][offsetX[3] >> 3 ]; // get hitting edge from the colors table
							if(object_colors[offsetY[3]][offsetX[3]] == GENERIC_COLOR_ENCODING)
								begin
									RGBout <= balls_colors[3];
								end
							else
								begin
									RGBout <= 8'h00;
